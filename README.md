...
See [DEVELOPMENT.md](DEVELOPMENT.md) for the fuller
...
Each commit here is a release, and accepted contributions are credited in
the release commit that ships them — see [CONTRIBUTING.md](CONTRIBUTING.md)
...
Third-party data redistributed with the app is credited in
[NOTICE.md](NOTICE.md).
