...
// browser then dropped June from a "3m" window whose server figures covered
// Jun+Jul+Aug — the best/worst caption was computed over a window one month
// shorter than the one being read.
//
