...
// left on the Accounts page the separation usually never happens. It is also the one step that MOVES REAL MONEY between the two
// sides, so it defaults to nothing selected, states plainly what assignment
