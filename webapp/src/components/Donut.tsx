// Donut + legend: ring geometry, center total, legend rows. Pure SVG.

// CVD-safe categorical palette, the same one as the server's charts.py
...
const fmt = (v: number) => {
  const n = pyround(v);              // rounds half-to-even like the server
