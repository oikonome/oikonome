...
// How long this charge has been out of pocket. It was computable from the
// date column and stated nowhere, which is what turns a list into a to-do.
...
// is invisible everywhere the person would look — however long
// /api/reimburse/unlink has existed on the server.
