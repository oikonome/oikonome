...
export default function Settings() {
  ...
  // the section list is sticky under the top bar, so it still needs
  // that bar's height measured — the rest of the geometry (scroll-spy,
  // per-section scroll-margin) went with the single scroll it served.
...
// our mail is not reaching this address, and here is the provider's
