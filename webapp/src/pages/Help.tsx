...
export default function Help() {
  ...
  // Phones: the topic index folds into a picker ABOVE the article. As a
  // second flex column it wrapped under the 15rem sidebar, so a phone
  // showed thirty links and the article started a screen and a half
  // below them — the page read as an index with nothing on it.
