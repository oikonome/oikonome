...
// every budget control lives here now, not split with Settings —
// fine-tuning, income scenarios and the bill tweaks that feed the plan came
// over, so there is one place to answer "what is my budget".
  ...
  return (
    <>
      ...
      {/* HERO: the plan as ONE flow line — the same sentence Today
          ...
          appears. The page used to lead with the planner FORM and bury "am I
          on plan" beneath it; editing is the rare act, checking is the daily
          one. */}
      {d && (
      ...
      {mayEdit && s.data && (
        <>
          ...
          {/* was a full card of read-only rows restating things set on the
              Bills page; it is one line now */}
