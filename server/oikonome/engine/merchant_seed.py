...
RULES: dict[str, tuple[str, ...]] = {
    ...
    "GENERAL_SERVICES": (
        ...
        "DISCOUNT TIRE", "PEP BOYS", "AUTOZONE",
    ...
    "TRANSPORTATION": (
        ...
        "QUIKTRIP", "RACETRAC", "SHEETZ", "CASEYS", "CASEY'S",
        ...
        "EZPASS", "FASTRAK", "TOLL", "PARKMOBILE",
    ...
    "RENT_AND_UTILITIES": (
        ...
        "DOMINION ENERGY", "CENTERPOINT", "AMEREN", "PSEG",
