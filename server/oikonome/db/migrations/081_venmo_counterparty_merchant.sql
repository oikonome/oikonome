...
-- Without this the ledger shows a wall of identical "Venmo" rows and every
-- person is invisible to grouping, search, and merchant totals.
--
-- sync/base.py (venmo_counterparty) derives the merchant on ingest for
...
-- Category fields and category_override are untouched.
