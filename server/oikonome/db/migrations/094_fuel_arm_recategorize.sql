...
-- line wins: Plaid files H-E-B's "H-E-B GAS/CARWASH #0118"
-- under FOOD_AND_DRINK_GROCERIES, which puts a tank of petrol inside a food
-- budget, and a Walmart fuel row under GENERAL_MERCHANDISE_SUPERSTORES.
-- sync/base.py now files these correctly on ingest; this does the same to
