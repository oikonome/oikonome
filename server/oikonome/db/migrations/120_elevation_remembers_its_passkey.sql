...
-- has to survive. "Freshly used" is the wrong test for that: POST /api/stepup/passkey is reachable by any
...
-- so the rotation would delete the owner's key and keep the stranger's.
--
