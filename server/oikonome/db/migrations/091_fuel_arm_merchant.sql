...
-- name "Costco Gas" (the outlet), and the bank's statement line survives
-- verbatim in raw.original_description:
--   COSTCO GAS #0007    -> the pump
--   COSTCO WHSE #0007   -> the warehouse
--   WWW COSTCO COM      -> online
