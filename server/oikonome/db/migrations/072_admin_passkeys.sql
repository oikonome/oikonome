...
--
-- The console's credential was ONE shared token (OIKONOME_ADMIN_TOKEN):
-- unattributable, un-rotatable without an edit + restart, phishable, and
-- plaintext on the host — and it reaches the root host-agent (restore,
-- reset, uninstall, reboot). These tables give it a real credential: a
...
-- docstring in web/adminconsole.py).
--
