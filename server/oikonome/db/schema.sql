...
--
-- TENANCY RULES (load-bearing; see DEVELOPMENT.md → Multi-tenancy):
...
-- Warehouse-club receipts, pushed by a host-side collector the way Amazon
-- orders are: one row per warehouse, gas-station or online receipt with its
