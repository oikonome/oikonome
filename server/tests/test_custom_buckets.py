...
The contract: custom buckets are a DECOMPOSITION layer over
...
class TestDecomposition(CustomBucketBase):
    ...
    def test_merchant_beats_category_cross_parent(self):
        """A merchant rule assigns the txn regardless of category —
...
class ApiTests(unittest.TestCase):
    ...
    def test_settings_caps_the_list_and_the_matchers(self):
        """custom_buckets carries a length cap like every settings list;
        otherwise ~20k minimal buckets fit the 1 MB body and make every
