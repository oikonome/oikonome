...
An earlier fix capped the EXPENSE side (Σ received per charge ≤ its gross) but not the
DEPOSIT side: one $100 insurance deposit could be partial-linked to N
different $100 charges, each link recording the FULL deposit amount —
netting them ALL to $0 shown spend while the true economics are $100 out.
