...
class DanglingPointers(unittest.TestCase):
    def test_alias_naming_a_missing_merchant_resolves_by_name(self):
        ...
        tid = add_txn(conn, "2026-07-01", 42.0, "NORTHWIND CLUB WHSE #0123",
                      merchant="Northwind Club Whse")
