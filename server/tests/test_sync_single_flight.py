...
skipped. The webhook-driven scoped sync takes it too; otherwise a webhook
arriving during the hourly sweep does exactly the damage the lock exists to
prevent.
"""
...
class WebhookSyncLockTests(unittest.TestCase):
    ...
    def test_a_failed_unlock_discards_the_connection(self):
        ...
        pool; a plain close() here would be exactly that return-to-pool."""
        class Conn:
