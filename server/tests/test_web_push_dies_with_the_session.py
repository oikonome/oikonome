...
Web push carries the verdict text and alert titles; unless the
subscription is tied to the session, a browser whose cookie was just
revoked keeps receiving them. Native tickles follow the device token's
revocation the same way.
"""
