...
class TestRetirement(unittest.TestCase):
    def test_age_from_birthdate(self):
        ...
        bd = "1975-05-10"
        self.assertEqual(R.age_from_birthdate(bd, dt.date(2026, 7, 6)), 51)
        self.assertEqual(R.age_from_birthdate(bd, dt.date(2026, 5, 10)), 51)
        self.assertEqual(R.age_from_birthdate(bd, dt.date(2026, 5, 9)), 50)
    ...
    def test_growth_chart_and_retire_table_agree_on_each_age(self):
        ...
        growth put the table one year of compounding ahead of the chart:
        $10k at 7% from 40 to 70 read $81,449 in one place and $76,123 in
        the other."""
