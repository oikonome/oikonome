"""Forecast walk arithmetic + card-payoff scenarios. Behaviour-frozen; do
not weaken one of these to make a change pass. Fixtures are per-tenant,
liabilities raw is jsonb, config rides tenant_settings, dates are date
objects.
"""
...
class TestForecast(unittest.TestCase):
    ...
    def test_checking_account_config_override(self):
        """NEW (generalization): checking_account_id config beats the
        largest-balance fallback."""
        self.conn.execute(
