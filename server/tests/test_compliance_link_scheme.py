...
Its scheme must be checked on write; otherwise `javascript:` stored on one
obligation runs for whoever opens the Business page — stored XSS inside the
tenant, written by an owner and executed by everyone.
"""
