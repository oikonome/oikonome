...
Every other posture change that evicts sessions drops them too; this door
did not, so a hijacker's browser kept receiving the verdict text and alert
titles after the owner recovered the account by email.
"""
