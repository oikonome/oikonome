...
class RouteInputValidationTests(unittest.TestCase):
    ...
    def test_transactions_bad_date_is_400(self):
        ...
        self.assertEqual(r.status_code, 400)
        # a well-formed date in a year the ledger cannot read is still bad
        # input, not a server error
        for q in ("date_from=0001-01-01", "date_to=9999-12-31",
                  "date_from=1799-01-01", "date_to=2201-01-01"):
