...
class ScriptTokenTests(unittest.TestCase):
    ...
    # The old prefix match ("/api/import"...) also covered rollback, the
    # batch list and bulk analyze/run — a leaked collector token could UNDO
    # imports and read import history. The allowlist is exact (method, path).
