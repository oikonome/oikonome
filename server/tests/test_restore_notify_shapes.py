...
The worker reads these every hour. An hour of "x" raised out of the
due-check and silenced every cadence; a recipient list written as one
string was iterated letter by letter; a phone that was not an object
crashed the send.
"""
