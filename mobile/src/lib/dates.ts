 ...
 *  real weekday column (packing only event days consecutively would
 *  break the alignment after the first gap). Mirrors the web's
 ...
 *  UI: when the app last pulled, and when the BANK last fed the aggregator. */
