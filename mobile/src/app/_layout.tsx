...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    // bare invalidate here refetched Today, Bills, Accounts, the alert
    ...
    import("expo-notifications").then((N) => {
      // a push that lands while the app is FOREGROUND is handed to us
      // instead of shown — without this handler it vanishes, which made
      // "send test push" (always tapped inside the app) look broken
