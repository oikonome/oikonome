...
// left are passkey sign-in and the guided first-run wizard (the footer
// says so); everything else ships here too.
...
const PAGES: [string, string, string, IconName][] = [
  ["Finish setup", "/welcome", "the guided first-run walkthrough",
   "flag-outline"],
