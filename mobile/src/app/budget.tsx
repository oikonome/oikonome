...
// broke mid-edit deletes: React reused the deleted row's TextInputs for
// its successor, so keyboard focus and the native selection stayed put
// on screen while the value under them shifted up. A counter, not
