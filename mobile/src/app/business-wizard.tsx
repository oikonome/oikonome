...
// scan, then the Business page takes over. Each answer drives something
// invisible from a form (structure → Schedule-C buckets, dates →
// §195/§248 window + compliance calendar), so each question is asked in
// plain words with its consequence beside it.
//
